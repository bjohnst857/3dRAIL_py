"""Rank test for the third-order (DIRK3 / ARS(4,4,3)) diffusion solver.

Same test case as ``1st_order/rank_test.py`` and ``2nd_order/rank_test.py``: a
sum-of-two-Gaussians initial condition advanced to a long final time on a coarse
grid, tracking how the multilinear rank evolves.  There is no exact solution to
compare against -- the only output is the rank-vs-time plot.
"""
import sys
